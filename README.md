...
For more details, refer to my research [report](https://docs.google.com/document/d/1P0-RoaRTZxS-yPdZcdrNeWGD_X1I_7Ir/edit?usp=drive_link&ouid=107271459588602317511&rtpof=true&sd=true) and the [SeqPredNN](https://doi.org/10.1186/s12859-023-05498-4) paper.
...
This will generate features (based off SeqPredNN's [featurise.py](https://github.com/falategan/SeqPredNN?tab=readme-ov-file#predicting-protein-sequences)) using PDB files from the example directory and create chain lists in the output directory.
